!function(a) {
    ...
    return function(a, b, c, d) {
        ...
        function j(a, b) {
            var c = a;
            return o.isString(a) ? t.Easings[a] || (c = !1) : c = o.isArray(a) && 1 === a.length ? h.apply(null, a) : o.isArray(a) && 2 === a.length ? u.apply(null, a.concat([ b ])) : o.isArray(a) && 4 === a.length ? i.apply(null, a) : !1, 
        ...
        function k(a) {
            if (a) {
                ...
                for (var f = 0; c > f; f++) if (t.State.calls[f]) {
                    var h = t.State.calls[f], i = h[0], j = h[2], m = h[3], n = !!m, q = null;
                    ...
                    for (var r = Math.min((b - m) / j.duration, 1), s = 0, u = i.length; u > s; s++) {
                        ...
                        if (g(y)) {
                            ...
                            for (var B in w) if ("element" !== B) {
                                var C = w[B], D, E = o.isString(C.easing) ? t.Easings[C.easing] : C.easing;
                                if (1 === r) D = C.endValue; else {
                                    var F = C.endValue - C.startValue;
                                    if (D = C.startValue + F * E(r, j, F), !n && D === C.currentValue) continue;
                                }
                                if (C.currentValue = D, "tween" === B) q = D; else {
                    ...
                    j.progress && j.progress.call(h[1], h[1], r, Math.max(0, m + j.duration - b), m, q), 
                    1 === r && l(f);
                }
            }
        ...
        function l(a, b) {
            ...
            for (var c = t.State.calls[a][0], e = t.State.calls[a][1], f = t.State.calls[a][2], h = t.State.calls[a][4], i = !1, j = 0, k = c.length; k > j; j++) {
                ...
                f.loop !== !0 && (p.queue(l)[1] === d || !/\.velocityQueueEntryFlag/i.test(p.queue(l)[1])) && g(l)) {
                    g(l).isAnimating = !1, g(l).rootPropertyValueCache = {};
                    var m = !1;
                    p.each(v.Lists.transforms3D, function(a, b) {
                        var c = /^scale/.test(b) ? 1 : 0, e = g(l).transformCache[b];
                        g(l).transformCache[b] !== d && new RegExp("^\\(" + c + "[^.]").test(e) && (m = !0, 
                        delete g(l).transformCache[b]);
                    }), f.mobileHA && (m = !0, delete g(l).transformCache.translate3d), m && v.flushTransformCache(l), 
            ...
            t.State.calls[a] = !1;
            for (var o = 0, q = t.State.calls.length; q > o; o++) if (t.State.calls[o] !== !1) {
                i = !0;
                break;
            }
        ...
        var u = function() {
            ...
            return function d(a, b, e) {
                var f = {
                    ...
                    tension: null,
                    friction: null
                }, g = [ 0 ], h = 0, i = 1e-4, j = .016, k, l, m;
                for (a = parseFloat(a) || 500, b = parseFloat(b) || 20, e = e || null, f.tension = a, 
                f.friction = b, k = null !== e, k ? (h = d(a, b), l = h / e * j) : l = j; ;) if (m = c(m || f, l), 
                g.push(1 + m.x), h += 16, !(Math.abs(m.x) > i && Math.abs(m.v) > i)) break;
                return k ? function(a) {
        ...
        var v = t.CSS = {
            ...
            Hooks: {
                ...
                register: function() {
                    ...
                    var c, d, e;
                    if (m) for (c in v.Hooks.templates) {
                ...
                injectValue: function(a, b, c) {
                    ...
                    if (d) {
                        var e = d[0], f = d[1], g, h;
                        return c = v.Hooks.cleanRootPropertyValue(e, c), g = c.toString().match(v.RegEx.valueSplit), 
                        g[f] = b, h = g.join(" ");
                    }
                    return c;
                }
                    ...
                    for (var a = 0; a < v.Lists.colors.length; a++) !function() {
                        ...
                        v.Normalizations.registered[b] = function(a, c, e) {
                            switch (a) {
                              ...
                              case "inject":
                                return 8 >= m ? 4 === e.split(" ").length && (e = e.split(/\s+/).slice(0, 3).join(" ")) : 3 === e.split(" ").length && (e += " 1"), 
                                (8 >= m ? "rgb" : "rgba") + "(" + e.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")";
                            }
                        };
                    }();
                }
            ...
            Names: {
                ...
                prefixCheck: function(a) {
                    ...
                    for (var b = [ "", "Webkit", "Moz", "ms", "O" ], c = 0, d = b.length; d > c; c++) {
                        ...
                        }), o.isString(t.State.prefixElement.style[e])) return t.State.prefixMatches[a] = e, 
                        [ e, !0 ];
                    }
                    return [ a, !1 ];
                }
            ...
            getPropertyValue: function(a, c, e, f) {
                function h(a, c) {
                    ...
                    if (8 >= m) i = p.css(a, c); else {
                        ...
                        var n;
                        n = g(a) === d ? b.getComputedStyle(a, null) : g(a).computedStyle ? g(a).computedStyle : g(a).computedStyle = b.getComputedStyle(a, null), 
                        "borderColor" === c && (c = "borderTopColor"), i = 9 === m && "filter" === c ? n.getPropertyValue(c) : n[c], 
                ...
                if (v.Hooks.registered[c]) {
                    ...
                    var l, n;
                    l = v.Normalizations.registered[c]("name", a), "transform" !== l && (n = h(a, v.Names.prefixCheck(l)[0]), 
                    v.Values.isCSSNullValue(n) && v.Hooks.templates[c] && (n = v.Hooks.templates[c][1])), 
                    i = v.Normalizations.registered[c]("extract", a, n);
                }
            ...
            setPropertyValue: function(a, c, d, e, f) {
                ...
                h = "transform", d = g(a).transformCache[c]; else {
                    ...
                    c = v.Normalizations.registered[c]("name", a)), h = v.Names.prefixCheck(c)[0], 8 >= m) try {
                        a.style[h] = d;
                    } catch (k) {
            ...
            flushTransformCache: function(a) {
                ...
                if ((m || t.State.isAndroid && !t.State.isChrome) && g(a).isSVG) {
                    ...
                    p.each(g(a).transformCache, function(b) {
                        return e = g(a).transformCache[b], "transformPerspective" === b ? (f = e, !0) : (9 === m && "rotateZ" === b && (b = "rotate"), 
                        void (c += b + e + " "));
                    }), f && (c = "perspective" + f + " " + c);
                }
        ...
        var w = function() {
            ...
            function e() {
                function a(a) {
                    function l(a, b) {
                        var c = d, g = d, h = d;
                        return o.isArray(a) ? (c = a[0], !o.isArray(a[1]) && /^[\d-]/.test(a[1]) || o.isFunction(a[1]) || v.RegEx.isHex.test(a[1]) ? h = a[1] : (o.isString(a[1]) && !v.RegEx.isHex.test(a[1]) || o.isArray(a[1])) && (g = b ? a[1] : j(a[1], f.duration), 
                        a[2] !== d && (h = a[2]))) : c = a, b || (g = g || f.easing), o.isFunction(c) && (c = c.call(e, y, x)), 
                        o.isFunction(h) && (h = h.call(e, y, x)), [ c || 0, g, h ];
                    }
                    function m(a, b) {
                        var c, d;
                    ...
                    function n() {
                        ...
                        }, d = a.position === I.lastPosition && a.myParent === I.lastParent, f = a.fontSize === I.lastFontSize;
                        I.lastParent = a.myParent, I.lastPosition = a.position, I.lastFontSize = a.fontSize;
                        var h = 100, i = {};
                        if (f && d) i.emToPx = I.lastEmToPx, i.percentToPxWidth = I.lastPercentToPxWidth, 
                        i.percentToPxHeight = I.lastPercentToPxHeight; else {
                            ...
                            t.CSS.setPropertyValue(j, "boxSizing", "content-box"), p.each([ "minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height" ], function(a, b) {
                        ...
                        i.remToPx = I.remToPx, i.vwToPx = I.vwToPx, i.vhToPx = I.vhToPx, t.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(i), e), 
                        i;
                    }
                    if (f.begin && 0 === y) try {
                        f.begin.call(q, q);
                    ...
                    if ("scroll" === C) {
                        var w = /^x$/i.test(f.axis) ? "Left" : "Top", z = parseFloat(f.offset) || 0, A, D, E;
                        f.container ? o.isWrapped(f.container) || o.isNode(f.container) ? (f.container = f.container[0] || f.container, 
                        A = f.container["scroll" + w], E = A + p(e).position()[w.toLowerCase()] + z) : f.container = null : (A = t.State.scrollAnchor[t.State["scrollProperty" + w]], 
                        D = t.State.scrollAnchor[t.State["scrollProperty" + ("Left" === w ? "Top" : "Left")]], 
                        E = p(e).offset()[w.toLowerCase()] + z), h = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: A,
                                currentValue: A,
                        ...
                        "none" === g(e).opts.display && (g(e).opts.display = "auto"), "hidden" === g(e).opts.visibility && (g(e).opts.visibility = "visible"), 
                        g(e).opts.loop = !1, g(e).opts.begin = null, g(e).opts.complete = null, u.easing || delete f.easing, 
                        u.duration || delete f.duration, f = p.extend({}, g(e).opts, f);
                        var F = p.extend(!0, {}, g(e).tweensContainer);
                        for (var G in F) if ("element" !== G) {
                            var H = F[G].startValue;
                            F[G].startValue = F[G].currentValue = F[G].endValue, F[G].endValue = H, o.isEmptyObject(u) || (F[G].easing = f.easing), 
                            t.debug && console.log("reverse tweensContainer (" + G + "): " + JSON.stringify(F[G]), e);
                        }
                        h = F;
                    } else if ("start" === C) {
                        var F;
                        g(e).tweensContainer && g(e).isAnimating === !0 && (F = g(e).tweensContainer), p.each(s, function(a, b) {
                        ...
                        for (var K in s) {
                            var L = l(s[K]), M = L[0], N = L[1], O = L[2];
                            K = v.Names.camelCase(K);
                            var P = v.Hooks.getRoot(K), Q = !1;
                            if (g(e).isSVG || "tween" === P || v.Names.prefixCheck(P)[1] !== !1 || v.Normalizations.registered[P] !== d) {
                                (f.display !== d && null !== f.display && "none" !== f.display || f.visibility !== d && "hidden" !== f.visibility) && /opacity|filter/.test(K) && !O && 0 !== M && (O = 0), 
                                f._cacheValues && F && F[K] ? (O === d && (O = F[K].endValue + F[K].unitType), Q = g(e).rootPropertyValueCache[P]) : v.Hooks.registered[K] ? O === d ? (Q = v.getPropertyValue(e, P), 
                                O = v.getPropertyValue(e, K, Q)) : Q = v.Hooks.templates[P][1] : O === d && (O = v.getPropertyValue(e, K));
                                var R, S, T, U = !1;
                                ...
                                S = "")), /[\/*]/.test(U)) S = T; else if (T !== S && 0 !== O) if (0 === M) S = T; else {
                                    ...
                                    switch (T) {
                                      case "%":
                                        O *= "x" === V ? i.percentToPxWidth : i.percentToPxHeight;
                                        break;
                                    ...
                                    switch (S) {
                                      case "%":
                                        O *= 1 / ("x" === V ? i.percentToPxWidth : i.percentToPxHeight);
                                        break;
                                ...
                                h[K] = {
                                    ...
                                    unitType: S,
                                    easing: N
                                }, t.debug && console.log("tweensContainer (" + K + "): " + JSON.stringify(h[K]), e);
                            } else t.debug && console.log("Skipping [" + P + "] due to a lack of browser support.");
                        }
                        h.element = e;
                    }
                    h.element && (v.Values.addClass(e, "velocity-animating"), J.push(h), "" === f.queue && (g(e).tweensContainer = h, 
                    g(e).opts = f), g(e).isAnimating = !0, y === x - 1 ? (t.State.calls.push([ J, q, f, null, B.resolver ]), 
                    t.State.isTicking === !1 && (t.State.isTicking = !0, k())) : y++);
                }
                var e = this, f = p.extend({}, t.defaults, u), h = {}, i;
                ...
                t.mock !== !1 && (t.mock === !0 ? f.duration = f.delay = 1 : (f.duration *= parseFloat(t.mock) || 1, 
                f.delay *= parseFloat(t.mock) || 1)), f.easing = j(f.easing, f.duration), f.begin && !o.isFunction(f.begin) && (f.begin = null), 
                f.progress && !o.isFunction(f.progress) && (f.progress = null), f.complete && !o.isFunction(f.complete) && (f.complete = null), 
                f.display !== d && null !== f.display && (f.display = f.display.toString().toLowerCase(), 
                "auto" === f.display && (f.display = t.CSS.Values.getDisplayType(e))), f.visibility !== d && null !== f.visibility && (f.visibility = f.visibility.toString().toLowerCase()), 
                f.mobileHA = f.mobileHA && t.State.isMobile && !t.State.isGingerbread, f.queue === !1 ? f.delay ? setTimeout(a, f.delay) : a() : p.queue(e, f.queue, function(b, c) {
                    return c === !0 ? (B.promise && B.resolver(q), !0) : (t.velocityQueueEntryFlag = !0, 
                    void a(b));
                }), "" !== f.queue && "fx" !== f.queue || "inprogress" === p.queue(e)[0] || p.dequeue(e);
            }
            var h = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || o.isString(arguments[0].properties)), i, m, n, q, s, u;
            if (o.isWrapped(this) ? (i = !1, n = 0, q = this, m = this) : (i = !0, n = 1, q = h ? arguments[0].elements || arguments[0].e : arguments[0]), 
            q = f(q)) {
                h ? (s = arguments[0].properties || arguments[0].p, u = arguments[0].options || arguments[0].o) : (s = arguments[n], 
                u = arguments[n + 1]);
                var x = q.length, y = 0;
                  ...
                  default:
                    if (!p.isPlainObject(s) || o.isEmptyObject(s)) {
                        if (o.isString(s) && t.Redirects[s]) {
                            var E = p.extend({}, u), F = E.duration, G = E.delay || 0;
                            return E.backwards === !0 && (q = p.extend(!0, [], q).reverse()), p.each(q, function(a, b) {
                                parseFloat(E.stagger) ? E.delay = G + parseFloat(E.stagger) * a : o.isFunction(E.stagger) && (E.delay = G + E.stagger.call(b, a, x)), 
                                E.drag && (E.duration = parseFloat(F) || (/^(callout|transition)/.test(s) ? 1e3 : r), 
                                E.duration = Math.max(E.duration * (E.backwards ? 1 - a / x : (a + 1) / x), .75 * E.duration, 200)), 
                                t.Redirects[s].call(b, b, E || {}, a, x, q, B.promise ? B : d);
                            }), a();
                        }
        ...
        p.each([ "Down", "Up" ], function(a, b) {
            t.Redirects["slide" + b] = function(a, c, e, f, g, h) {
                var i = p.extend({}, c), j = i.begin, k = i.complete, l = {
                    height: "",
                    marginTop: "",
                    marginBottom: "",
                    paddingTop: "",
